...
public class UtilsJSON {
    ...
    public <T> T deserialize(String str, Class<T> tClass){
        ...
        try {
            ...
            log.error("Возникла ошибка при десериализации, пожалуйста обратите внимание что в качестве класса десериализатора, должен быть класс с идентичной структурой как в JSON");
    ...
    public <T> T deserializeList(String str, TypeReference<T> tTypeReference){
        ...
        try {
            ...
            log.error("Возникла ошибка при List десериализации, пожалуйста обратите внимание что в качестве класса десериализатора, должен быть класс с идентичной структурой как в JSON");
